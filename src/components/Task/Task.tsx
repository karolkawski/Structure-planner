...
import type { TaskType } from './Task.d';
...
function Task({ task }: { task: TaskType }) {
  ...
  return (
    <div className={`Task h-40 w-full flex m-1 ml-40 `} key={task.id}>
      <div
      ...
      <div className="Task__Details flex flex-col justify-center items-start grow pl-2">
      ...
      <div className="Task__Confirmation flex items-center">
        <div className="me-4  ">
          <input
            ...
            value=""
            className={`w-8 h-8 ${checkBoxVariants[task.color]} roundeddark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600`}
          />
        </div>
      </div>
    </div>
